...
namespace BlueMuse
{
    static class Constants
    {
        ...
        public static readonly Guid MUSE_TOGGLE_STREAM_UUID = new Guid("00001801-0000-1000-8000-00805f9b34fb");
        public static readonly int[] MUSE_TOGGLE_STREAM_START = new int[3] {0x02, 0x64, 0x0a};
        public static readonly int[] MUSE_TOGGLE_STREAM_STOP = new int[3] { 0x02, 0x68, 0x0a };
